...
class _BarChart extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    for (var entry in statsData.entries) {
      ...
      final int averageDistance = value['averageDistance'].ceil();
      if (averageDistance > max) {
        max = averageDistance;
      }
    }
  ...
  List<BarChartGroupData> get barGroups {
    return statsData.entries.map((entry) {
      ...
      final averageDistance = value['averageDistance'].toString();
      ...
      return BarChartGroupData(
        ...
        barRods: [
          BarChartRodData(
            toY: double.parse(averageDistance).roundToDouble(),
